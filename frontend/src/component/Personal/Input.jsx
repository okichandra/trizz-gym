    ...
    return (
        <div className='flex flex-col gap-2 relative'>
            ...
            <div className='relative'>
                <input type={type === 'password' ? (showPassword ? 'text' : 'password') : type} id={id} placeholder={placeholder} value={value} onChange={onChange} className='bg-third-background py-2 px-7 pr-12 rounded-lg text-sm w-full' />
