...
function SideBar() {
    return (
        <div className='Sidebar max-md:fixed bg-secondary-background max-md:left-1/2 max-md:-translate-x-1/2 md:block max-md:bottom-6 max-md:w-5/6 md:w-1/4 md:h-full md:py-10 flex flex-col gap-10 shadow-[0_0_0_1px_rgba(225,225,225,.1)] max-md:rounded-4xl z-10'>
            ...
            <nav className="flex md:flex-col py-3 px-7 md:px-0 justify-between">
                <NavLink
                    to="/account"
                    className={({ isActive }) =>
                ...
                >
                    <div className='flex flex-col md:flex-row items-center gap-2'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            <path
                                stroke="currentColor"
                                stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0M12 14a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7" />
                        </svg>
